...
{
    public class PruebaEjercicioRepository : IRepository<ResultadoPruebaResistencia>
    {
        ...
        /// </summary>
        public PruebaEjercicioRepository()
        {
        ...
        public void Insert(ResultadoPruebaResistencia entity)
        {
        ...
        public void Update(ResultadoPruebaResistencia entity)
        {
        ...
        /// </summary>
        /// <param name="entity">Entidad Rol.</param>
        public void Delete(ResultadoPruebaResistencia entity)
        {
        ...
        public void Save()
        {
            using (TransactionScope scope = new TransactionScope())
            {
                try
                {
                    ...
                    {
                        foreach (ResultadoPruebaResistencia objPrueba in _insertItems)
                        {
                    ...
                    {
                        foreach (ResultadoPruebaResistencia objPrueba in _updateItems)
                        {
        ...
        public IEnumerable<ResultadoPruebaResistencia> GetAll()
        {

            List<ResultadoPruebaResistencia> listaPruebas = null;
        ...
        /// <returns>Rol</returns>
        public ResultadoPruebaResistencia GetById(int id)
        {
            ResultadoPruebaResistencia objPrueba = null;
            //List<ResultadoPruebaResistencia> listaPruebas = new List<ResultadoPruebaResistencia>();
        ...
        /// <returns></returns>
        private void UpdatePrueba(ResultadoPruebaResistencia objPrueba)
        {
            int id;
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@PID_TIPO_PRUEBA", objPrueba.IdPrueba));
                cmd.Parameters.Add(new SqlParameter("@PID", objPrueba.Id));
                cmd.Parameters.Add(new SqlParameter("@PPESO", objPrueba.Peso));
                cmd.Parameters.Add(new SqlParameter("@PID_TIPO_PRUEBA", objPrueba.Peso));
        ...
        private void InsertPrueba(ResultadoPruebaResistencia objPrueba)
        {
            DataSet ds;
            ds = null;
            int id;
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@PEJERCICIO", objPrueba.IdEjericio));
                cmd.Parameters.Add(new SqlParameter("@PSERIES", objPrueba.Series));
                cmd.Parameters.Add(new SqlParameter("@PREPETICIONES", objPrueba.Repeticiones));
