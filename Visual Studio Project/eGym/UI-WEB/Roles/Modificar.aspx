<%@ Page Language="vb" AutoEventWireup="true"  MasterPageFile="~/shared/Site.Master" CodeBehind="Modificar.aspx.vb" Inherits="UI_WEB.Modificar3" %>
										...
										<ul class="list" id="listaPermisos" data-sortable="true">
                                               ...
                                               <div class="form-group">
													<div class="input-group-btn">
														<button class="btn btn-default" type="button" onclick="ActualizarRol()">Guardar</button>
													</div>
                                                	<div class="input-group-btn">
