...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <section class="style-default-bright">
            ...
            <h2 class="text-primary">Reporte de eventos </h2>
                    ...
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="941px">
                        <LocalReport ReportEmbeddedResource="UI_WEB.ReporteEventos.rdlc" ReportPath="Reportes/ReporteEventos.aspx">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DsEventos" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="UI_WEB.eGymDBDataSetTableAdapters.T_EVENTOTableAdapter"></asp:ObjectDataSource>
        </div>
            <div class="row">
                <!--end .col -->
                <div class="col-lg-12">
