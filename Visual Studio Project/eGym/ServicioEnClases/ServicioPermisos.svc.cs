...
namespace ServicioEnClases
{
    ...
    public class ServicioPermisos
    {
        ...
        GestorPermiso objGestorPermiso = new GestorPermiso();
        [WebGet()]
        [OperationContract]
        public string obtenerPermiso()
        {
            List<Permiso> listaPermiso = new List<Permiso>();
            listaPermiso = objGestorPermiso.listarPermisos().ToList();
            return new JavaScriptSerializer().Serialize(listaPermiso);
